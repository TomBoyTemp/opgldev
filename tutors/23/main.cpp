...
public:
    ...
    Main()
    {
        ...
        m_spotLight.AmbientIntensity = 0.0f;//начальный "солнечный" свет
        m_spotLight.DiffuseIntensity = 0.1f;//начальный рассе€ный свет
        m_spotLight.Color = Vector3f(1.0f, 1.0f, 1.0f);//цвет света
        m_spotLight.Attenuation.Linear = 0.01f;//
        m_spotLight.Position  = Vector3f(-20.0, 20.0, 5.0f);//позици€ света
        m_spotLight.Direction = Vector3f(1.0f, -1.0f, 0.0f);//направление
        m_spotLight.Cutoff =  0.0f;
    }
    ...
    virtual void ShadowMapPass()
    {
        ...
        p.Rotate(-m_scale, cosf(m_scale), 0.0f);
        p.WorldPos(0.0f, 0.0f, 5.0f);//ƒальше/ближе, вверх вниз, влево/вправо
